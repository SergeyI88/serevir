...
<head>
    ...
    <script>alert("Здравствуйте. Вам продлена подписка на месяц(до 12 ноября 2018 года), так как в приложении ещё не всё настроено. " +
        "Мы будем благодарны, если вы сообщите нам на почту onl.ont@mail.ru " +
        "что вас не устраевает в приложении, какие есть ошибки и пожелания по функционалу");</script>
    <%
        }
    %>
</head>
