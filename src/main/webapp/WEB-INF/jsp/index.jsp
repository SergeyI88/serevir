...
<head>
    ...
    <script>alert("Здравствуйте. Если вы найдете какие-нибудь ошибки или у вас есть предложения по улучшению функционала. " +
        "Мы будем благодарны, если вы сообщите нам на почту onl.ont@mail.ru или по номеру телефона указанного в поддержке.");</script>
    <%
        }
    %>
</head>
