...
public enum EnumFields {
    ...
    , GROUP("группа", null, false, null)
    , TYPE("тип", new String[]{"alcohol_not_marked", "normal", "alcohol_marked", "service"}, false, null)
    , QUANTITY("количество", null, false, true)
    , MEASURE_NAME("название меры"
            , new String[]{"", "шт", "кг", "л", "м", "км", "м2", "м3", "компл", "упак", "ед", "дроб", "штука"}
            , false, true)
    , CODE("код", null, false, null) //[ 0 .. 10 ] characters
    , BAR_CODES("штрих-коды", null, false, true)
    , PRICE("цена", null, true, true) //[ 0 .. 9999999.99 ] double
    , COST_PRICE("цена закупки", null, false, true) //[ 0 .. 9999999.99 ] double
    , TAX("налог", new String[]{"NO_VAT", "VAT_10", "VAT_18", "VAT_0", "VAT_18_118", "VAT_10_110"}, false, true)
    , ALLOW_TO_SELL("разрешено к продаже", null, false, true)
    , DESCRIPTION("описание", null, false, true)
